...
const PaymentDailog = () => {
  ...
  const [paymentMethod, setPaymentMethod] = React.useState<
    "online" | "local" | null
  >(null);
  const [selectedLocalPayment, setSelectedLocalPayment] = React.useState(
    localPayments[0]
  );
          ...
          <div className="container mx-auto p-4">
            ...
            <div className="flex justify-center space-x-6 my-6">
              <div
                ...
                } p-6 border rounded-lg cursor-pointer hover:shadow-lg`}
              ...
              <div
                className={`${
                  paymentMethod === "local" && "border-green-600"
                } p-6 border rounded-lg cursor-pointer hover:shadow-lg`}
            ...
            {paymentMethod === "local" && (
              <>
                  ...
                  {localPayments.map((payment) => (
                    <div
                      ...
                      className={`p-4 border rounded-lg cursor-pointer ${
                        selectedLocalPayment.title === payment.title &&
                        "border-green-600"
                      }`}
                    >
                      {payment.title}
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="mt-4 px-6 py-2 bg-main-500 text-white rounded-lg hover:bg-main-600"
                  >
                    Submit
                  </button>
                </form>
